...
import com.system.tennis_management_system.Pojo.UserPojo;
...
import com.system.tennis_management_system.entity.User;
...
//    }
    ...
    public String getTennisProfiile(@PathVariable("id") Integer id, Model model, Principal principal ){
        ...
        model.addAttribute("userdata",userService.findByEmail(principal.getName()));
        model.addAttribute("bookedtennis", booking);
        return "editbooking";
    }
...
//        Booking booking =bookingService.fetchById(id);
//        model.addAttribute("bookedtennis", new BookingPojo(booking));
//        return "redirect:/home/homepage";
//    }
