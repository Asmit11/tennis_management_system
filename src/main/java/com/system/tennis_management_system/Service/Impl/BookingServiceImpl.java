...
import com.system.tennis_management_system.Repo.BookingRepo;
import com.system.tennis_management_system.Repo.TennisRepo;
import com.system.tennis_management_system.Repo.UserRepo;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingPojo saveOrder(BookingPojo bookingPojo) {
        ...
        booking.setTennis(tennisRepo.findById(bookingPojo.getFid()).orElseThrow());
...
//        return time;
    ...
    private void sendPassword(String email, String name, String tennis, String date, String time){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Booking Verification");
        message.setText("Hi"+ name+ "You have booked"+tennis+"tennis"+"on"+ date+"from"+time+"please be on time");
    ...
    public void processPasswordResetRequest(String email){
        ...
        if(bookingOptional.isPresent()){
            ...
            String tennis = booking.getTennis().getTennisname();
            String time = booking.getStarting();
            String date = String.valueOf(booking.getDate());
            sendPassword(email, name, tennis, time, date);
